...
και περιγράφεται με τη μορφή ενός [διαγράμματος ροής](schediasi/logismiko/algorithmos.jpg). Ο [πηγαίος κώδικας](
2022_openedtech_competition/schediasi/logismiko/arduino_programs/BinBot/BinBot.ino ) από το πρόγραμμα του Arduimo είναι διαθέσιμος στον αντίστοιχο φάκελο του αποθετηρίου.
