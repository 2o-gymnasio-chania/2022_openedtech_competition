...
Η σχεδίαση του ρομπότ επέλεξε υλικό και λογισμικό ανοιχτής αρχιτεκτόνικής. Οι αισθητήρες υπερύθρων είναι δύο, τοποθετημένοι στο καπάκι του δοχείου, με προσανατολισμό προς το εσωτερικό του δοχείου. Μπορούν ανα πάσα στιγμή να καθορίζουν την πληρότητα του δοχείου, μετρώντας την απόσταση από την κορυφή των απορριμάτων εντός του δοχείου. Ο ενεργοποιητής επιλέχθηκε να είναι της μορφής RC servo για τη δυνατότητά του να περιστρέφεται στα δύο ακραία σημεία που αντιστοιχούν στο ανοιχτό ή κλειστό καπάκι. Η οθόνη υγρών κρυστάλλων ενημερώνει το χρήστη του δοχείου αλλά και το προσωπικό συλλογής απορριμάτων για την κατάσταση πληρότητας του κάδου.
