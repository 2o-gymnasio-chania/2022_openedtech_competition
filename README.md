...
Η σχεδίαση του ρομπότ επέλεξε υλικό και λογισμικό ανοιχτής αρχιτεκτονικής. Οι αισθητήρες υπερύθρων είναι δύο, τοποθετημένοι στο καπάκι του δοχείου, με προσανατολισμό προς το εσωτερικό του δοχείου. Μπορούν ανα πάσα στιγμή να καθορίζουν την πληρότητα του δοχείου, μετρώντας την απόσταση από την κορυφή των απορριμάτων εντός του δοχείου.
...
Μετά από έρευνα που κάναμε στο διαδίκτυο συνειδητοποιήσαμε ότι δεν έχει ασχοληθεί κάποια ομάδα σοβαρά με αυτό το θέμα. Στην πόλη μας σπάνια μπορεί κανείς να συναντήσει τέτοιου είδους μηχανήματα καθώς ο περισσότερος πληθυσμός δεν νοιάζεται ιδιαίτερα για το θέμα της διαχείρισης των απορριμμάτων. Ηιδέα μας θα βελτιώσει την απόδοση του συστήματος συλλογής των απορριμάτων.
...
2022_openedtech_competition/schediasi/logismiko/arduino_programs/BinBot/BinBot.ino ) από το πρόγραμμα του Arduimo είναι διαθέσιμος στον ανίστοιχο φάκελο του αποθετηρίου.
...
Όλες οι σχετικές κατασκευές πραγματοποιήθηκαν στο εργαστήριο του 2ου Γυμνασίιου Χανίων. Δεν απαιτήθηκε η χρήση εξειδικευμένων εργαλείων ή κατεργασιών κατά τη συναρμολόγηση των εξαρτημάτων.

<img src="photos/kataskeyes/kataskeyes_3.jpg" width=60%>
<img src="photos/kataskeyes/kataskeyes_4.jpg" width=60%>

*Στιγμιότυπα από τις εργασίες της ομάδας κατά την κατασκευή της βάσης του ρομπότ*
