...
![binBot](photos/binBot_afisa.jpg)
Η ομάδα Trashformers του 2ου Γυμνάσιου Χανίων συμμετέχει στον 4o Πανελλήνιο Διαγωνισμό Ανοιχτών Τεχνολογιών, σχεδιάζοντας, προγραμματίζοντας και κατασκευάζοντας το πρωτότυπο ρομπότ binBot. Το binBot είναι ένα ρομπότ που εφαρμόζει την κυκλική οικονομία στη διαχείριση των απορριμάτων.
...
![Η ομάδα Trashformers και το πρωτότυπο ρομπότ binBot](photos/binBot_2.jpg)
...
Με τη βοήθεια του ρομπότ binBot μπορούν να αντιμετωπιστούν τα παρακάτω προβλήματα:
- Αποτελεσματική διαχείριση απορριμάτων από τα απορριμματοφόρα οχήματα
- Καθαρότερες πόλεις
...
*Σχέδια μαθητή σχετικά με την αρχική ιδέα για το πρωτότυπο ρομπότ κυκλικής οικονομίας binBot*
...
<img src="schediasi/idees/idea_2.jpg" width=60%>

*Εναλλακτικά σχέδια μαθητή σχετικά με την αρχική ιδέα για το πρωτότυπο ρομπότ κυκλικής οικονομίας binBot*
...
<img src="photos/exoplismos/aisthitires.jpg" width=60%>

*Οι δύο αισθητήρες υπερύθρων τοποθετημένοι στην εσωτερική μεριά του καπακιού του κάδου*

Η σχεδίαση του ρομπότ επέλεξε υλικό και λογισμικό ανοιχτής αρχιτεκτονικής. Οι αισθητήρες υπερύθρων είναι δύο, τοποθετημένοι στο καπάκι του δοχείου, με προσανατολισμό προς το εσωτερικό του δοχείου. Μπορούν ανά πάσα στιγμή να καθορίζουν την πληρότητα του δοχείου, μετρώντας την απόσταση από την κορυφή των απορριμάτων εντός του δοχείου.

<img src="photos/exoplismos/energopoiitis_kleidaria.jpg" width=60%>
...
<img src="photos/exoplismos/arduino_LCD.jpg" width=60%>
...
Μετά από έρευνα που κάναμε στο διαδίκτυο συνειδητοποιήσαμε ότι δεν έχει ασχοληθεί κάποια ομάδα σοβαρά με αυτό το θέμα. Στην πόλη μας σπάνια μπορεί κανείς να συναντήσει τέτοιου είδους μηχανήματα καθώς ο περισσότερος πληθυσμός δεν νοιάζεται ιδιαίτερα για το θέμα της διαχείρισης των απορριμμάτων. Η ιδέα μας θα βελτιώσει την απόδοση του συστήματος συλλογής των απορριμάτων.
...
<img src="schediasi/yliko/schedio_1.jpg" width=60%>

<img src="schediasi/yliko/schedio_2.jpg" width=60%>

<img src="schediasi/yliko/schedio_3.jpg" width=60%>
...
και περιγράφεται με τη μορφή ενός [διαγράμματος ροής](schediasi/logismiko/algorithmos.jpg). Ο [πηγαίος κώδικας](schediasi/logismiko/arduino_programs/BinBot/BinBot.ino) από το πρόγραμμα του Ardui	o είναι διαθέσιμος στον αντίστοιχο φάκελο του αποθετηρίου.

Πιο συγκεκριμένα ο κανόνας λειτουργίας του ρομπότ είναι:
- Αν οι αισθητήρες στο καπάκι αντιληφθούν ότι το δοχείο έχει γεμίσει, τότε θα προβληθεί ένα ενημερωτικό μήνυμα στην οθόνη του δοχείο και ο ενεργοποιητής θα ασφαλίσει το καπάκι.
- Αν οι αισθητήρες δεν έχουν εντοπίσει πληρότητα στο δοχείο τότε επανέλαβε τον έλεγχο.

<img src="schediasi/logismiko/algorithmos.jpg" width=60%>

*Το διάγραμμα ροής του αλγορίθμου ελέγχου του ρομπότ*
...
<img src="photos/kataskeyes/kataskeyes_3.jpg" width=60%>
<img src="photos/kataskeyes/kataskeyes_4.jpg" width=60%>

*Στιγμιότυπα από τις εργασίες της ομάδας κατά την κατασκευή του ρομπότ*

### Προγραμματισμός ###

Ο προγραμματισμός έγινε με τη βοήθεια του, ανοιχτής αρχιτεκτονικής, προγραμματιστικού περιβάλλοντος Arduino IDE, για το ρομποτικό ελεγκτή Arduino Uno. Το πρόγραμμα που αναπτύχθηκε, σύμφωνα με τους παραπάνω αλγορίθμους είναι διαθέσιμο στο αποθετήριο, με το όνομα [BinBot.ino](schediasi/logismiko/arduino_programs/BinBot/BinBot.ino).

### Μηχανισμοί και ηλεκτρονικά ###

Το πρωτότυπο ρομπότ binBot κατασκευάστηκε τον Ιούνιο του 2022 από την ομάδα Trashformers του 2ου Γυμνασίου Χανίων. Χρησιμοποιήθηκαν κοινά εργαλεία και υλικά για γρήγορη πρωτοτυποποίηση, όπως πλαστικό και κόλλες. Το τελικό αποτέλεσμα της κατασκευής, καθώς και τα επιμέρους εξαρτήματα του ρομπότ φαίνονται στις φωτογραφίες παρακάτω. Ο απαιτούμενος ηλεκτρονικός εξοπλισμός αγοράστηκε υπό την αιγίδα του διαγωνισμού και τοποθετήθηκε στο ρομπότ χρησιμοποιώντας τεχνικές γρήγορης και εύκολης συναρμολόγησης και πρωτοτυποποίησης.

<img src="photos/exoplismos/exoplismos.jpg" width=60%>

*Το πρωτότυπο ρομπότ binBot, σχεδιασμένο και κατασκευασμένο από την ομάδα Trashformers του 2ου Γυμνασίου Χανίων.
(1) υπέρυθροι αισθητήρες υπολογισμού απόστασης - χρησιμοποιούνται για τον έλεγχο της πληρότητας του κάδου, (2) ενεργοποιητής τύπου RC servo - χρησιμοποιείται για το κλείδωμα του καπακιού του δοχείου, (3) ρομποτικός ελεγκτής Arduino Uno rev3, (4) συσσωρευτής ηλεκτρικής ενέργειας 12 V και (5) οθόνη υγρών κρυστάλλων - χρησιμοποιείται για την προβολή μηνυμάτων*
...
- [https://github.com/2o-gymnasio-chania/2022_openedtech_competition](https://github.com/2o-gymnasio-chania/2022_openedtech_competition)
...
<img src="OER_canvas/OER_canvas_binBot.png" width=50%>
